...
public class AuthService {
    ...
    public Object signup(EmployeeDTO employeeDTO) {
        ...
        /* 이메일 중복 유효성 검사(선택적) */
        if(employeeRepository.findByEmployeeEmail(employeeDTO.getEmployeeExternalEmail()) != null){ // 중복된 내용이 있으니 값을 가지고 온 것 (없으면 null)
        ...
        * */
        LoginEmployeeRole registMemberRole = new LoginEmployeeRole(result1.getEmployeeCode(), 2);
